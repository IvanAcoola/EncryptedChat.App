...
class CK_VISIBLE_PUBLIC CkPdfW  : public CkClassWithCallbacksW
{
	...
	//     WriteStandardXref - When writing the PDF, write the cross reference section
	//     in standard format if possible. (The "standard format" is the older
	...
	//     noDss - Set this boolean to true to prevent adding a /DSS (Document Security
	//     Store).
