...
class CK_VISIBLE_PUBLIC CkCrypt2  : public CkClassWithCallbacks
{
	...
	// Sets the digital certificate to be used in verifying a signature. In virtually
	// all cases, a PKCS7 (CMS) signature already embeds the signing certificate
	// information, and it is not necessary to explicitly call this method to specify
	// the verification certificate. It is only needed in rare cases.
